...
[twikoo](https://github.com/imaegoo/twikoo) 也是一个很不错的评论插件，不过由于独立部署文档的缺失以及外观上更喜欢 [Waline](https://waline.js.org/) 的缘故，最终还是选择了 [Waline](https://waline.js.org/)。
